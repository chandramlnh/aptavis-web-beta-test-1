                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <button wire:click.prevent="removeMatch({{ $index }})" class="btn btn-danger btn-block">Delete Match {{ $index + 1 }}</button>
                        </div>
                    </div>
                </div>
            </div>
            @if ($errors->has('newMatch.'.$index))
                <div class="alert alert-danger d-block">{{ $errors->first('newMatch.'.$index) }}</div>
            @endif
        @endforeach
        <div class="row">
            <div class="d-grid gap-2 col-12 mb-3">
                <button wire:click.prevent="addMatch()" class="btn btn-primary btn-block">Add Match</button>
                <hr class="w-100">
